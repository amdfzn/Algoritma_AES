...
public class AESManual {
        ...
        public static void main (String[] args) {
            ...
            aes.showResults(data, key, encryptedText, encryptedHexText, decryptedText);
    }
        ...
        public void showResults(String data, String key, String encryptedText, String encryptedHexText, String unencryptedText) {
            ...
            System.out.println("Decrypted Text: " + unencryptedText + " ----- size: " + unencryptedText.length() + " bytes");
        }
}
